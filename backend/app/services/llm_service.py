...
# from ..core.prompt_engineering import qa_template
...
#                 print(roles)
#                 return roles, skills_data, content, self.calculate_threshold_scores(skills_data)
...
#     async def process_custom_prompt(self, prompt: str, skills_data: dict):
#         try:
#             with ThreadPoolExecutor() as executor:
#                 custom_prompt_template = ChatPromptTemplate.from_template(
#                     """Based on the following skills data and custom prompt, update the skills metrics:
#                     Skills Data: {skills_data}
#                     Custom Prompt: {prompt}
#                     Please maintain the same format for the response."""
#                 )
